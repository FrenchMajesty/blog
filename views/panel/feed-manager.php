			...
			<div class="row">
				<div class="col-md-12">
					<div class="post-mediums">
						...
						<div class="row post-medium nopacity visible animated fadeInUp">
							<div class="col-md-5">
								<div class="row" style="height: 311px;"><img src="<?php echo $sitelink; ?>/static/images/img-26.png" alt=""></div>
							</div>
							<div class="col-md-7">
								<div class="post-item" style="height: 311px;">
									<div class="medium-post-box clearfix">
										...
										<div class="post-item-paragraph">
											<h2><a href="#">Meet #59 Interface Designer John Doe</a></h2>
											<p class="ellipsis-readmore" style="word-wrap: break-word;">Praesent mollis sodales est, eget fringilla libero sagittis eget. Nunc gravida varius risus ac luctus. Mauris ornare eros sed libero euismod ornare. Nulla id sem a mauris egestas pulvinar vitae non dui. Cras... <a class="more" href="#">»</a></p>
										</div>
										<div class="pm-bottom-info clearfix">
											<div class="pull-left">
												27 June&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;By <a href="#">Justin Freen</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-md-7">
								<div class="post-item" style="height: 365.625px;">
									<div class="medium-post-box clearfix">
										...
										<div class="post-item-paragraph">
											<h2><a href="#">Long Live The Kings - Short Film Documentary</a></h2>
											<p class="ellipsis-readmore" style="word-wrap: break-word;">Sed vel magna leo, in pretium nunc. Ut ornare turpis vel ipsum vulputate lacinia. Pellentesque blandit sagittis tempor. Vivamus nec mauris pulvinar leo dignissim sollicitudin eleifend eget velit... <a class="more" href="#">From »</a></p>
										</div>
										<div class="pm-bottom-info clearfix">
											<div class="pull-left">
												23 June&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;<a href="#">#road</a>
											</div>
										</div>
									</div>
								</div>
